...
export var point_of_entry_style = {
	'lineHeight': '50px',
	'height': '50px',
	'width': '50px',
...
export function assign_style_to_element(element, style){
