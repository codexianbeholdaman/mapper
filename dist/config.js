...
export const _CONFIG_ACCESS_POINT_DATA = 'auxclick';
//Map, for which terrains defined in 'game_terrain.js' file will be used
export const _CONFIG_GAME = 'Curse of the Azure Bonds';
